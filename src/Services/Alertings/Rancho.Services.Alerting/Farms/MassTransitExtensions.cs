...
using Rancho.Services.Alerting.Farms.Features.CreatingFarm.v1.Events.Integration.External;
using Rancho.Services.Shared.Management.Farms.Events.v1.Integration;

namespace Rancho.Services.Alerting.Farms;
    ...
    internal static void AddFarmEndpoints(this IRabbitMqBusFactoryConfigurator cfg, IBusRegistrationContext context)
    {
        cfg.ReceiveEndpoint(
            ...
            re =>
            {
                ...
                re.ConfigureConsumer<FarmCreatedConsumer>(context);
