...
using Rancho.Services.Feeding.Api.Extensions.ApplicationBuilderExtensions;
using Spectre.Console;

namespace Rancho.Services.Feeding.Api;

public class Program
{
    public static async Task Main(string[] args)
    {
        AnsiConsole.Write(new FigletText("Feeding Service").Centered().Color(Color.FromInt32(new Faker().Random.Int(1, 255))));
