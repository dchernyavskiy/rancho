...
namespace Rancho.Services.Feeding.Shared.Extensions.WebApplicationExtensions;
...
public static partial class WebApplicationExtensions
{
    public static async Task ApplyDatabaseMigrations(this WebApplication app)
    {
        ...
        if (configuration.GetValue<bool>("PostgresOptions:UseInMemory") == false)
        {
            ...
            var catalogDbContext = serviceScope.ServiceProvider.GetRequiredService<FeedingDbContext>();
