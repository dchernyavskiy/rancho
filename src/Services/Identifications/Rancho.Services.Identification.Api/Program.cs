...
using Rancho.Services.Identification.Api.Extensions.ApplicationBuilderExtensions;
...
public class Program
{
    ...
    {
        AnsiConsole.Write(
            new FigletText("Identification Service").Centered().Color(Color.FromInt32(new Faker().Random.Int(1, 255))));
