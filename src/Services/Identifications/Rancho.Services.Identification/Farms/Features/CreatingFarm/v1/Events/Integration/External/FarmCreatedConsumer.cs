...
namespace Rancho.Services.Identification.Farms.Features.CreatingFarm.v1.Events.Integration.External;
...
public class FarmCreatedConsumer : IConsumer<FarmCreatedV1>
{
    ...
    public FarmCreatedConsumer(IIdentificationDbContext context, ILogger<FarmCreatedConsumer> logger)
    {
        _context = context;
        _logger = logger;
    }
