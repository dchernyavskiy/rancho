...
using Rancho.Services.Identity.Users;
...
public static partial class WebApplicationBuilderExtensions
{
    public static WebApplicationBuilder AddInfrastructure(this WebApplicationBuilder builder)
    {
            ...
            rolePolicies: new List<RolePolicy>
                          {
                              ...
                              new(IdentityConstants.Role.Farmer, new List<string> {IdentityConstants.Role.Farmer}),
                          });
        ...
        builder.Configuration.AddEnvironmentVariables("Rancho_identity_env_");
        ...
        builder.AddCustomMassTransit(
            (context, cfg) =>
            {
                ...
                cfg.AddFarmerEndpoints(context);
            },
