...
using Rancho.Services.Identity.Users.Features.GettingUerByEmail.v1;
using Rancho.Services.Identity.Users.Features.GettingUserById.v1;
using Rancho.Services.Identity.Users.Features.RegisteringUser.v1;
using Rancho.Services.Identity.Users.Features.UpdatingUserState.v1;
using Rancho.Services.Identity.Shared;
using Rancho.Services.Identity.Users.Features.UpdatingUser.v1;
...
internal class UsersConfigs : IModuleConfiguration
{
    ...
    public IEndpointRouteBuilder MapEndpoints(IEndpointRouteBuilder endpoints)
    {
        ...
        // usersGroupV1.MapUpdateUserEndpoint();
