...
using Rancho.Services.Management.Api.Extensions.ApplicationBuilderExtensions;
using Spectre.Console;

namespace Rancho.Services.Management.Api;

public class Program
{
    public static async Task Main(string[] args)
    {
        AnsiConsole.Write(new FigletText("Management Service").Centered().Color(Color.FromInt32(new Faker().Random.Int(1, 255))));
