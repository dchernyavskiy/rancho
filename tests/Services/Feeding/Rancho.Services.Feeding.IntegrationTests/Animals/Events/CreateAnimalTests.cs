...
public class CreateAnimalTests : FeedingServiceIntegrationTestBase
{
    public CreateAnimalTests(SharedFixtureWithEfCore<Api.Program, FeedingDbContext> sharedFixture, ITestOutputHelper outputHelper) : base(sharedFixture, outputHelper)
    {
    }
