...
// using Rancho.Services.Management.TestShared.Fakes.Customers.Commands;
// using Rancho.Services.Management.TestShared.Fakes.Customers.Entities;
// using Rancho.Services.Management.TestShared.Fakes.Customers.Events;
// using Tests.Shared.XunitCategories;
//
// namespace Rancho.Services.Management.TestShared.Fakes.Customers;
//
// public class Tests
// {
//     public class Events
